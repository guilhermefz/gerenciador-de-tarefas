...
export const TaskDetail = () => {
    ...
    return (
        <div className="flex min-h-[calc(100vh-68px)] items-start justify-center bg-slate-900 px-6 py-10">
            <div className="w-full max-w-3xl space-y-6">
                <div className="bg-slate-950 rounded-2xl p-8 shadow-lg text-white">
                ...
                {token && <ComentariosSection tarefaId={+id!} token={token} />}
            </div>
        </div>
    );
};
